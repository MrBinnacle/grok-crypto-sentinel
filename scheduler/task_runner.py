    ...
    def run_daily_scan(self, persona: str = "novice_plus") -> str:
        ...
        for asset in self.default_assets:
            try:
                ...
                signal_id = self.performance_tracker.log_signal(enriched_signal, persona)
    ...
    def run(self):
        ...
        try:
            ...
            if evaluation_results["evaluated"] > 0:
                print(f"Evaluated {evaluation_results['evaluated']} signals, {evaluation_results['accuracy']:.1%} accuracy")
