...
class PerformanceTracker:
    ...
    def log_signal(
        self, signal: Union[Dict[str, Any], EnrichedBreakoutSignal], persona: str
    ) -> str:
    ...
    def evaluate_signals(self) -> Dict[str, float]:
        ...
        accuracy = (
            float(winners_count) / evaluated_count if evaluated_count > 0 else 0.0
        )
    ...
    def get_performance_stats(self) -> Dict:
        ...
        evaluated_signals = [
            s
            for s in performance_data["signals"].values()
