...
class BusinessOutcomeTracker:
    ...
    def create_public_case_study(self, business_profile: Dict, problem: str, framework_used: str) -> str:
        ...
        case_study = {
            ...
            "recommendations": self._generate_framework_recommendations(problem, framework_used),
    ...
    def track_outcome_metrics(self, case_id: str, actual_results: Dict) -> Dict:
        ...
        for metric, predicted_value in predictions.items():
            ...
            if predicted_value != 0:
                ...
                accuracy_scores[metric] = max(0, accuracy)  # Cap at 0 for negative accuracy
        ...
        outcome_data = {
            ...
            "framework_effectiveness": self._assess_framework_effectiveness(overall_accuracy),
    ...
    def generate_credibility_report(self) -> Dict:
        ...
        accuracy_scores = [case["outcome_data"]["overall_accuracy"] for case in completed_cases]
        ...
        return {
            ...
            "credibility_score": self._calculate_credibility_score(avg_accuracy, len(completed_cases)),
